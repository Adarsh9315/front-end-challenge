      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Build amazing things with our powerful and intuitive tools designed for modern developers
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600">
              Flexible design system that adapts to your brand
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <button className="px-8 py-4 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 transition-colors shadow-lg">

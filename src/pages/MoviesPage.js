...
const MoviesPage = () => {
	...
	const getNominationsLength = () => {
		const savedNominations = localStorage.getItem('nominations');
		return savedNominations ? JSON.parse(savedNominations).length : 0;
	};
	...
	return (
		<div className='container-fluid movie-app'>
			...
			<div className='banner' style={{display: getNominationsLength() === 5 ? 'block' : 'none'}}>
